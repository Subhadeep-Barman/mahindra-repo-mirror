...
def upgrade() -> None:
    ...
    sa.Column('ps_pump', sa.String(), nullable=True),
    ...
    sa.Column('name_of_updater', sa.String(), nullable=True),
    sa.Column('updated_on', sa.TIMESTAMP(), nullable=True),
    sa.PrimaryKeyConstraint('test_order_id')
    )
    ...
    sa.Column('tyre_run_in', sa.Float(), nullable=True),
    sa.Column('engine_run_in', sa.Float(), nullable=True),
    sa.Column('gearbox_run_in', sa.Float(), nullable=True),
    sa.Column('axle_run_in', sa.Float(), nullable=True),
    sa.Column('engine_oil_specification', sa.String(), nullable=True),
    sa.Column('axle_oil_specification', sa.String(), nullable=True),
    sa.Column('transmission_oil_specification', sa.String(), nullable=True),
