...
export default function VTCEnginePage() {
  ...
  const handleEditClick = async (engine) => {
    try {
      console.log("Clicking on VTC engine:", engine.engine_serial_number); // Debug log
      ...
      console.log("VTC Engine API Response:", response.data); // Debug log
      ...
      if (response.data && response.data.length > 0) {
        ...
        console.log("Found matching VTC engine:", engineData); // Debug log
