          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50">
                ...
                <TableHead className="font-semibold text-gray-700">Team Type</TableHead>
            ...
            <TableBody>
              {currentUsers.map((user, index) => (
                  ...
                  <TableCell className="text-gray-600">{user.teamType}</TableCell>
                  <TableCell>
                    <Badge
      ...
      <Dialog open={isAddUserModalOpen} onOpenChange={setIsAddUserModalOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            {/* Team Type */}
            <div className="space-y-2">
              <Label htmlFor="teamType" className="text-sm font-medium text-gray-700 dark:text-red-500">
                Team Type
              </Label>
              <Select value={newUser.teamType} onValueChange={(value) => handleInputChange("teamType", value)}>
                <SelectTrigger className="w-full">
