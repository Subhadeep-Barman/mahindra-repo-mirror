      ...
      <div className="bg-white dark:bg-black min-h-screen">
        ...
        <div className="flex items-center justify-between px-8 pt-6">
          <div className="flex items-center gap-4">
            <Button variant="outline" className="bg-red-600 text-white px-3 py-1 rounded">Chennai Job Order</Button>
        ...
        {showCoastDown && (
          <div className="mx-8 mb-4 border rounded shadow px-6 py-4">
            ...
            <div className="flex items-center mt-4 gap-6">
              <Button className="bg-white text-red-900 border border-red-900 text-xs px-6 py-2 rounded">CREATE JOB ORDER</Button>
              <Button
