...
const vehicleBodyNumbers = [
  {
    body: "V.B.NO123456",
    vehicle: "V.S.NO123456",
    engine: "E.S.NO123456",
    engineType: "Diesel",
  },
  {
    body: "V.B.NO654321",
    vehicle: "V.S.NO654321",
    engine: "E.S.NO654321",
    engineType: "Gasoline",
  },
];
      ...
      <div className="bg-white dark:bg-black min-h-screen">
            ...
            >
              ...
              <SelectContent>
                {vehicleBodyNumbers.map((v) => (
                  <SelectItem key={v.body} value={v.body}>
                    {v.body}
                  </SelectItem>
                ))}
              </SelectContent>
          ...
          <div className="mx-8 mt-2 mb-4 border rounded shadow">
            ...
            >
              <span className="font-semibold text-sm">
                Vehicle Details (from Vehicle Form)
              </span>
        ...
        {engineFormData && (
          <div className="mx-8 mt-2 mb-4 border rounded shadow">
            ...
            >
              <span className="font-semibold text-sm">
                Engine Details (from Engine Form)
              </span>
        ...
        {tests.map((test, idx) => (
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-4 mb-2">
              <div className="col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleTestChange(idx, "instructions", e.target.value)
                  }
            ...
            <div className="flex justify-end mt-4">
              <Button className="bg-red-600 text-white text-xs px-6 py-2 rounded">
                ✓ UPDATE JOB ORDER
              </Button>
            </div>
          </div>
        ...
        {/* Coast Down Toggle */}
        <div className="flex items-center gap-2 mx-8 mt-8 mb-2">
          <span className="font-semibold text-sm">Coast Down Data (CD)</span>
          <Switch checked={showCoastDown} onCheckedChange={setShowCoastDown} />
        </div>
        ...
        {showCoastDown && (
          <div className="mx-8 mb-4 border rounded shadow px-6 py-4">
            ...
            <div className="flex items-center mt-4 gap-6">
              <Button className="bg-white text-red-900 border border-red-900 text-xs px-6 py-2 rounded">
                CREATE JOB ORDER
              </Button>
              <Button
