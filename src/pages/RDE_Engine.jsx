...
export default function RDEEnginePage() {
  ...
  const handleEditClick = async (engine) => {
    try {
      console.log("Clicking on RDE engine:", engine.engine_serial_number); // Debug log
      ...
      console.log("RDE Engine API Response:", response.data); // Debug log
      ...
      if (response.data && response.data.length > 0) {
        ...
        console.log("Found matching RDE engine:", engineData); // Debug log

        // Navigate to the engine form page with complete engine data
        navigate(`/chennai/engine/new?department=RDE%20JO&edit=true`, {
          state: {
