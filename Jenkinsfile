...
mm_docker_build_common
{
    ...
    IMAGE_NAME              = "gto-dbmrs-vtc-frontend-test"
    CLOUD                   = "gcp"
    AGENT                   = ""
    APP_NAME                = "gto-dbmrs-vtc-frontend-test"
...
mm_k8s_deployment_pipeline_gcp_common
{
    ...
    ENVIRONMENT             = "dev"
    DEPLOYMENT_NAME         = "gto-dbmrs-vtc-frontend-test"
    DEPLOYMENT_TYPE         = "automatic"
    RESTRICT_TO_BRANCH      = "jenkins_frontend_test"
